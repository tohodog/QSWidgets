 ...
 * 拖曳图片验证码
 */
public final class DragImageCaptchaView extends FrameLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public DragImageCaptchaView(Context context) {
        super(context);
        init();
    }

    public DragImageCaptchaView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DragImageCaptchaView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        tvTips.addColorRegex("拼图|成功|失败|正确|[\\d\\.%]+", 0xfff75151);
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        if (dragListenner != null) {
            float proportion = seekBar.getProgress() * 1f / seekBar.getMax();
            dragListenner.onDrag(proportion, (int) (proportion * (cover.getWidth() - block.getWidth())));
        }
    }
    //===================seekbar监听===================
    ...
    private void failAnime() {
        TranslateAnimation translateAnimation = new TranslateAnimation(
                Animation.RELATIVE_TO_SELF, -0.005f, Animation.RELATIVE_TO_SELF,
                0.005f, Animation.RELATIVE_TO_SELF, 0f,
                Animation.RELATIVE_TO_SELF, 0f);
        translateAnimation.setInterpolator(new CycleInterpolator(1));
        translateAnimation.setDuration(200);
        flContent.startAnimation(translateAnimation);
    }
    ...
    public interface DragListenner {
        ...
        void onDrag(float proportion, int x);
